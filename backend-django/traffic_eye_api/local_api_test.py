...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'neurocity_project.settings')
try:
    import django
    django.setup()
...
IMAGE_NAME = '8.jpg'  # Set your test image name here (e.g. 'd3.jpg', '8.jpg', 'fb2.jpg')
image_path = os.path.join(ASSETS_DIR, IMAGE_NAME)

print("=" * 60)
print("[Test] NEUROCITY TRAFFIC EYE - STANDALONE MODEL TEST")
print("=" * 60)
...
print("[Test] Image found! Running YOLOv8 Inference...\n")
...
try:
    ...
    if raw_result is not None:
        ...
        print(f"[Test] ANNOTATED IMAGE OVERWRITTEN AT: {output_filepath}\n")

    # Remove raw YOLO tensor result for clean console output
    result.pop('raw_results_object', None)

    print("[Test] MODEL INFERENCE OUTPUT:")
