...
export default function TrafficSimulation({ onBackToAnalyzer, onNavigate }) {
  ...
  return (
    <div className={`w-full min-h-screen bg-[#F8FAFC] text-[#CAF0F8] transition-all duration-700 relative overflow-hidden select-none pb-12 ${emergencyOverride ? 'shadow-[inset_0_0_100px_rgba(239,68,68,0.25)] border border-red-500/20' : ''
      }`}>
      ...
      <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 mt-4">
